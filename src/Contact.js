  ...
  const formik = useFormik({
    ...
    validate: (values) => {
      ...
      if (values.PhNo.toString().length !== 10) {
        error.PhNo = "Enter valid Phone number with 10-digit";
      }
        ...
        <div className="row">
          ...
          <div className="col-lg-4">
            <img
              ...
              src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSotUfxeMEV8N6bC8ydM9DrFkasw8b4CinsWPA2aZH-3lzW8nNZ0UjQWFZ5fUfXc_pUBsM&usqp=CAU"
              alt="image"
              width={"40px"}
              height="400px"
            />
          ...
          <div className="col-lg-6">
            <form onSubmit={formik.handleSubmit} className="col-lg-8">
              ...
              {formik.touched.Message && formik.errors.Message ? (
                  <span style={{ color: "crimson" }}>{formik.errors.Message}</span>
                ) : null}
              <br />
              ...
              />
              {formik.touched.PhNo && formik.errors.PhNo ? (
                <span style={{ color: "crimson" }}>{formik.errors.PhNo}</span>
              ) : null}
              <br />
